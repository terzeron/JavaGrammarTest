package com.terzeron.grammar.version;
...
public class VersionCheck {
    ...
    public static void main(String[] args) throws IOException {
        System.out.println("com.terzeron.grammar.version of bytecode: " + getVersionDetails("target/classes/com/terzeron/grammar/com.terzeron.grammar.version/VersionCheck.class"));
    }
